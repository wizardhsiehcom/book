...
const BOOKS = [
  ...
  },
  {
    ...
    tags: ["inspection", "metrology", "V5"],
    href: "book/v5/html/index.html",
    accent: "#0891b2",
    glow: "rgba(8,145,178,0.18)",
  },
  {
  ...
  },
  {
    icon: "🧪",
    title: "從測試看懂矽格",
    desc: "從測試插入點、測試機小時成本、高速與光電共測，走到矽格的服務證據與擴產主張",
    tags: ["IC test", "OSAT", "Sigurd"],
    href: "book/sigurd/html/index.html",
    accent: "#d946ef",
