...
本計畫是對 `docs/semi-jobs/`（原 26 頁，約 2,000 行）的完整審查結果與補強執行方案。原審查日期：2026-07-06；執行與重新查證：2026-08-31 至 2026-09-01。全書原內容停在 2024–2025 年，時效性、職務覆蓋與無來源薪資是主要問題。

> **執行狀態：主體完成。** 已完成三組研究、全角色頁更新、薪酬與趨勢重寫，新增良率／產品、智慧製造、記憶體、術語與資料來源頁。元件、量測與海外外派未獨立成頁；相關內容已併入製程／良率／設備章，海外外派留待取得可公開驗證的制度資料後再寫。
...
- [x] 26 舊頁完成事實、角色邊界、過時數字與來源更新
- [x] 新增良率／產品、智慧製造、記憶體、glossary 與 references
- [x] appendix-trends 以 2026 視角全面改寫，區分實績、預測與職涯推論
- [x] 撤下無法雙來源驗證的角色 × 年資薪資表，改為三層資料口徑
- [x] README 的承諾與各職務頁內容一致
- [x] MkDocs build 無 error、無文件警告
- [ ] 元件、量測、海外外派若取得足夠公開資料，再評估是否獨立成頁
