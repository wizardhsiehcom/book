...
OUT = ROOT / 'data/psi/validation/final'
    ...
    with sync_playwright() as p:
        ...
        for mode, viewport in [('desktop', {'width': 1440, 'height': 1000}), ('mobile', {'width': 390, 'height': 844})]:
            ...
            for name in names:
                ...
                if data['overflow'] or not data['footer'] or errors or any(d['errors'] or not d['visible'] for d in data['diagrams']):
                ...
                if name in ('index.html', '04-reuse-economics.html', '06-thinning-services.html', '09-psi-evidence-map.html'):
...
(ROOT / 'plan/psi/browser-validation.json').write_text(json.dumps(report, ensure_ascii=False, indent=2), encoding='utf-8')
