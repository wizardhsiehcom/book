...
> 本文件保留初次建書驗收；其後已補入 4 張 Commons 照片與 2 張原創 SVG。最新補圖結果見 [補圖驗收](image-update-validation.md)，最新正文版本見 image-manifest.json。
...
| 共享資源 | 已執行 `bash ./sync-assets.sh`；未改其他書正文或共用主題 |
