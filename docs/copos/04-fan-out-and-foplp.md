...
- **台灣的力成（PTI）等封測廠**與**群創等面板廠**，也都在面板級封裝與其設備、材料上有布局；台灣面板業的既有產線與玻璃加工經驗，正是後來被重新看好的基礎。
- **Deca Technologies** 則走了另一條路：它不做量產，而是提供 **Adaptive Patterning** 這項解決 die shift 的關鍵技術授權（原理見 [13 面板級製程流程](13-process-flow.md)）。
...
於是多年來一直是「配角」的面板級封裝，被 AI 需求推上了高階舞台。TSMC 的 CoPoS，正是把面板級封裝與 2.5D 中介層架構結合、瞄準最高階 AI 封裝的那一步。

## 2026 年的實況：門檻仍在，但已有人跨進來

要有現實感的是，**三道門檻並沒有消失**，只是在部分產品上被跨過了：

| 廠商 | 進度（2026 年） |
|------|---------------|
| 三星電機 | Galaxy Watch 的 SiP 封裝，**2018 年即量產** |
| 群創 | 成熟製程 FOPLP，**2025 Q2 量產，良率 >90%**，月出貨從 400 萬顆成長到 4,000 萬顆以上；取得 SpaceX 訂單 |
| 日月光 | **310 × 310 mm 產線正式發表**（2026-05-26），支援 2/2 μm 線寬線距，目標 2027 上半年投產 [官方] |
| 力成 | 投資逾 10 億美元，目標 2027 上半年量產，**產能已預訂至 2030 年**；與 Broadcom 成立合資 |

但關鍵的分野仍然存在：**已量產的都是成熟製程、粗線寬的產品；沒有任何 AI 加速器等級的面板封裝在全球任何地方量產。**

「做大面板」與「在大面板上做 2/2 μm 細線寬並維持高良率」之間，仍隔著 CoPoS 要爬的那條良率學習曲線。
