...
前面幾章把 CoPoS 的好處講得很動人：大封裝的利用率衝上 90%、成本有下降空間。這頁是技術深水區，要回答一個殘酷的問題——**既然圓換方這麼好，為什麼不早就做？**

答案是：從圓到方，遠遠不是「把晶圓機台等比放大」就能達成。面板級製程有一整排新難題，每一項都可能把理論紅利打回原形。

一個很能說明問題的事實：**台積電據報曾試過 515 × 515 mm 的面板，後來才退回 310 × 310 mm** 來控制翹曲風險 [報導]。願意在規格上往回退一步，通常代表遇到的不是小問題。

> 本頁列出五類挑戰的全景；其中最核心的**製程流程選擇與 die shift 補償**，因為值得展開，另闢 [13 面板級製程流程](13-process-flow.md) 專章討論。
...
這正是為什麼 CoPoS 的路線是「**先在 310 × 310 mm 把良率學會，再考慮逐代放大**」——而不是一步到位。也是為什麼台積電高層強調「沒有捷徑」、規模量產仍需二至三年。

理論上的幾何紅利是確定的；能不能兌現、什麼時候兌現，取決於這條良率學習曲線爬得多快。截至 2026 年 8 月的報導指出，台積電預期**良率與技術成熟還需要約一年**才能穩定 [報導]。

還有兩個業界至今沒有成熟解法的環節——**大面積矩形面板的電鍍均勻性**，以及**組裝設計套件（ADK）的標準化缺口**——在 [13 面板級製程流程](13-process-flow.md) 展開。實際時程與里程碑見 [09 TSMC 布局與時程](09-tsmc-roadmap.md)。

> 下一頁：[面板級製程流程與 die shift](13-process-flow.md)　｜　相關頁面：[從圓到方](06-panel-geometry.md) ｜ [玻璃基板](07-glass-substrate.md) ｜ [設備與量測生態](14-equipment-ecosystem.md)
