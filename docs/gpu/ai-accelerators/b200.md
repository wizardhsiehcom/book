...
|------|---------|---------|------|
| 架構 | Blackwell | Hopper | — |
| FP8 TFLOPS（含 sparsity） | ~9,000 | 3,958 | ~2.3× |
| FP4 TFLOPS（含 sparsity） | ~18,000 | 不支援 | 新增 |
...
8 個 B200 透過 NVLink 5.0 互連，每 GPU 有 1.8 TB/s 的 All-to-All 頻寬，讓 Tensor Parallelism 的通訊成本幾乎可忽略。
