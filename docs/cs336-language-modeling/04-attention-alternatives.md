...
- Course material：`data/cs336/lectures material/lecture_04.pdf`。狀態：已核對 PDF metadata / outline；投影片未完整閱讀。
- Assignment 關聯：待補。本批核對的 Assignment 1-3 檔案中，尚未確認有直接針對 attention alternatives 或 MoE 的實作範圍。
