...
- Course material：Lecture 11 PDF，`data/Stanford CS336 Language Modeling from Scratch/cs336_materials/lectures-main/lecture_11.pdf`，已下載，待材料階段閱讀。
- Assignment 關聯：Assignment 3（Scaling），code repo 已下載，待材料階段閱讀；逐字稿本身在本講未明確提及 Assignment 3 的細節。
- 本章只整理能力要求與關聯，不提供作業解答。
