...
- `data/Stanford CS336 Language Modeling from Scratch/cs336_materials/lectures-main/lecture_06.py`：已下載，待材料階段閱讀。
- `data/Stanford CS336 Language Modeling from Scratch/cs336_materials/lectures-main/var/traces/lecture_06.json`：已下載，待材料階段閱讀。
