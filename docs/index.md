...
| 你的背景 | 建議起點 | 接著讀 |
|---------|---------|--------|
| 半導體製程工程師 | [TSV 基礎](cowos/02-tsv-basics.md) | [CoWoS-S](cowos/05-cowos-s.md)、[可靠性](cowos/10-reliability-manufacturing.md) |
| AI/系統架構工程師 | [為什麼需要先進封裝](cowos/01-why-advanced-packaging.md) | [HBM 整合](cowos/07-hbm-integration.md)、[AI 應用](cowos/08-cowos-ai-hpc.md) |
| 初學者 | [全書地圖](cowos/00-map.md) | 依章節順序 |

## 內容定位

本筆記以公開論文、TSMC 官方技術文件、IEEE ECTC 發表內容與教科書為基礎整理，不重現受版權保護的原文，僅提供原創概念整理與學習導引。詳見[學習資源與論文導讀](cowos/appendix-references.md)。
